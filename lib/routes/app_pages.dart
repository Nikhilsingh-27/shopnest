...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: Routes.shippingPolicy, page: () => const ShippingPolicyScreen()),
    GetPage(name: Routes.returnsRefunds, page: () => const ReturnsRefundsScreen()),
    GetPage(name: Routes.privacyPolicy, page: () => const PrivacyPolicyScreen()),
    GetPage(name: Routes.termsConditions, page: () => const TermsConditionsScreen()),
